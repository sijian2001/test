...
class TestCategoryRepository:
    ...
    def test_get_all_categories_success(self):
        ...
        self.mock_session.query.return_value.all.return_value = mock_categories
        ...
        self.mock_session.query.assert_called_once_with(Category)
    ...
    def test_get_category_by_id_success(self):
        ...
        self.mock_session.query.return_value.filter.return_value.first.return_value = mock_category
    ...
    def test_get_categories_by_parent_success(self):
        ...
        self.mock_session.query.return_value.filter.return_value.all.return_value = mock_categories
    ...
    def test_create_category_success(self):
        ...
        # Assert
        assert result == mock_category
        self.mock_session.add.assert_called_once_with(mock_category)
        self.mock_session.commit.assert_called_once()
        self.mock_session.refresh.assert_called_once_with(mock_category)
        self.mock_db_session.get_session.assert_called_once_with("test2")
    ...
    def test_update_category_success(self):
        ...
        self.mock_session.merge = Mock(return_value=mock_category)
        self.mock_session.commit = Mock()
        ...
        # Assert
        assert result == mock_category
        self.mock_session.merge.assert_called_once_with(mock_category)
        self.mock_session.commit.assert_called_once()
        self.mock_db_session.get_session.assert_called_once_with("test2")
    ...
    def test_delete_category_success(self):
        ...
        with patch.object(self.repository, 'get_category_by_id', return_value=mock_category):
            ...
            self.mock_session.delete.assert_called_once_with(mock_category)
            self.mock_session.commit.assert_called_once()
    ...
    def test_delete_category_not_found(self):
        ...
        with patch.object(self.repository, 'get_category_by_id', return_value=None):
            ...
            assert not hasattr(self.mock_session, 'delete') or not self.mock_session.delete.called
    ...
    def test_db_session_called_for_all_methods(self):
        ...
        # Assert get_session was called 8 times with "test2" parameter
        assert self.mock_db_session.get_session.call_count == 8

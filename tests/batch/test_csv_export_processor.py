...
from app.batch.csv_export_processor import UserInfoCsvExportProcessor
...
class TestUserInfoCsvExportProcessor:
    ...
    @patch('app.batch.csv_export_processor.os.path.exists')
    @patch('app.batch.csv_export_processor.os.makedirs')
    @patch('app.batch.csv_export_processor.open', new_callable=mock_open)
    ...
    def test_run_csv_export_process_sorts_by_user_id(self, mock_file, mock_makedirs, mock_exists):
        ...
        with patch('app.batch.csv_export_processor.csv.DictWriter') as mock_dict_writer:
            mock_writer = Mock()
    ...
    @patch('app.batch.csv_export_processor.os.path.exists')
    @patch('app.batch.csv_export_processor.os.makedirs')
    @patch('app.batch.csv_export_processor.open', side_effect=IOError("File write error"))
    ...
    @patch('app.batch.csv_export_processor.os.makedirs', side_effect=OSError("Permission denied"))
    @patch('app.batch.csv_export_processor.os.path.exists')
    ...
    def test_run_csv_export_process_calls_search_user_info_correctly(self):
        ...
        with patch('app.batch.csv_export_processor.open', mock_open()):
            with patch('app.batch.csv_export_processor.os.path.exists', return_value=True):
                # Act
    ...
    @patch('app.batch.csv_export_processor.logging.getLogger')
